defmodule ExchangeZoo.Bybit.Model.OrderEvent do
  ...
  @stop_order_types ~w(take_profit stop_loss trailing_stop stop partial_take_profit partial_stop_loss tpsl_order)a
  @tpsl_modes ~w(full partial)a
  @trigger_by ~w(last_price index_price mark_price)a
